...
1. Get the container's name or container ID:
        ...
        ed335aaa9b82        kylemanna/openvpn:latest   ovpn_run            5 minutes ago       Up 5 minutes        0.0.0.0:587->587/udp   sad_lovelace
...
2. Tail the logs:
        ...
        + conf=/etc/openvpn/udp587.conf
        + openvpn --config /etc/openvpn/udp587.conf
